...
mainApp.controller('SVG_Ctrl', function($scope) {
	...
	$scope.myFunction = function() {
		...
		if(current_green_state!=past_green_state){
			...
			svg_green_state = ""+String(time_stamp)+"," +String(10 + 0 * 50)+"," + String(time_stamp) + "," + String(10 + !current_green_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_green_state * 50) + "";	
			}
			else{
			svg_green_state = ""+String(time_stamp)+"," +String(10 + 1 * 50)+"," + String(time_stamp) + "," + String(10 + !current_green_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_green_state * 50) + "";	
			}}
		else{
			svg_green_state = "" + String(time_stamp) + "," + String(10 + !current_green_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_green_state * 50) + "";
			}
		...
		if(current_blue_state!=past_blue_state){
			...
			svg_blue_state = ""+String(time_stamp)+"," +String(10 + 0 * 50)+"," + String(time_stamp) + "," + String(10 + !current_blue_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_blue_state * 50) + "";	
			}
			else{
			svg_blue_state = ""+String(time_stamp)+"," +String(10 + 1 * 50)+"," + String(time_stamp) + "," + String(10 + !current_blue_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_blue_state * 50) + "";	
			}}
		else{
			svg_blue_state = "" + String(time_stamp) + "," + String(10 + !current_blue_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_blue_state * 50) + "";
			}
			
			
		if(current_res_red_state!=past_res_red_state){
			if (current_res_red_state==0){
			svg_res_red_state = ""+String(time_stamp)+"," +String(10 + 0 * 50)+"," + String(time_stamp) + "," + String(10 + !current_res_red_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_res_red_state * 50) + "";	
			}
			else{
			svg_res_red_state = ""+String(time_stamp)+"," +String(10 + 1 * 50)+"," + String(time_stamp) + "," + String(10 + !current_res_red_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_res_red_state * 50) + "";	
			}}
		else{
			svg_res_red_state = "" + String(time_stamp) + "," + String(10 + !current_res_red_state * 50) + "," + String(time_stamp + 12) + "," + String(10 + !current_res_red_state * 50) + "";
			}
